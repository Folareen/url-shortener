...
const Hero = () => {
  return (
    <section className='w-full py-4 pl-4 lg:pl-40 relative z-10 '>
        <div className='flex flex-col h-4/5 lg:flex-row-reverse lg:my-10'>
            <div className='w-full lg:w-1/2 ml-[25px] mr-[-25px] '>
                <img src={working} alt="working illustration"  className='w-full h-full '/>
            </div>
            <div className='w-full text-center lg:text-left mt-4 lg:w-1/2 lg:h-full lg:py-3 lg:mr-[30px]'>
